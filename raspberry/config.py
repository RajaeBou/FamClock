...
# Charge le fichier .env du dossier raspberry
load_dotenv()
...
# Nombre logique de canaux disponibles, pas les pins GPIO
SERVO_CHANNEL_COUNT = int(os.getenv("SERVO_CHANNEL_COUNT", "2"))
